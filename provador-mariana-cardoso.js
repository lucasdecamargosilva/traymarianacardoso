            ...
            <div class="mc-card-ia">
                ...
                <div class="mc-content-scroll">
                    ...
                    <div id="mc-step-upload">
                        ...
                        <div id="mc-terms-row" onclick="(function(){var t=window._mcTerms=!window._mcTerms;document.getElementById('mc-terms-icon').textContent=t?'☑':'☐';document.getElementById('mc-terms-row').style.opacity=t?'1':'0.6';var n=document.getElementById('mc-phone').value.replace(/\D/g,'');var p=(n.length===10||n.length===11)&&/^[1-9][1-9]/.test(n)&&(n.length===10||n[2]==='9');document.getElementById('mc-btn-generate').disabled=!(window._mcPhoto&&p&&t);})()" style="display:block;margin:14px 0 0;font-size:13px;color:#444;text-align:center;line-height:1.6;cursor:pointer;opacity:0.6;user-select:none;">
